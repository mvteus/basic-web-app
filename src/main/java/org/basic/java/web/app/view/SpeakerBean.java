package org.basic.java.web.app.view;
...
import org.basic.java.web.app.model.Speaker;
...
public class SpeakerBean implements Serializable {
	...
	@PersistenceContext(unitName = "basic-java-web-app-persistence-unit", type = PersistenceContextType.EXTENDED)
